...
An inclusive, fully accessible application designed specifically for blind and visually impaired students to develop and master their mental math skills, built from the ground up with screen reader compatibility in mind.
...
MentalMath provides an inclusive environment specifically tailored to the visually impaired, supporting their aspirations to excel at mental mathematics. Because the developer is also blind, every piece of this program was built with extensive care and first-hand understanding of the needs of this marginalized community.



I discovered a severe lack of applications in this field that prioritize screen reader users. I personally needed an app exactly like this, so I decided to build it. It is completely open-source, highly accessible, constantly actively developed, and all suggestions are warmly welcomed.
...
Studies show that over 70% of people dislike math. I hope this app will grow, change lives, and help many blind and visually impaired users discover a true love for mathematics.
...
Upon opening the app, you will find a tab bar allowing you to select your preferred method of practicing.
...
The application generates dynamic math problems across five distinct levels of difficulty:
...
Once in the Practice Area, type your answer into the input field and press `Enter`. An audio cue will immediately indicate whether your answer was correct or incorrect.
...
After finishing a practice session, a Results Dialog will appear containing:
...
The settings menu allows you to tailor the app to your preferences:
...
Contributions to translate the app into new languages are highly encouraged! To submit a translation:
...
If you have trouble with Pull Requests, feel free to reach out to Anas via email or Telegram to submit your translation!
...
All contributions—whether it's code, bug reports, or translations—are immensely welcome. Please feel free to open an issue or submit a pull request!
