...
class settings (qt.QDialog):
    def __init__(self,p):
        ...
        self.speechSettings=tabs.speechSettings(self)
        self.sectian.add(_("Speech settings"),self.speechSettings)
        self.sectian.add(_("update"),self.update)
        restoar=tabs.Restoar(self)
        self.sectian.add(_("Backup and restore"),restoar)
    ...
    def fok(self):
        ...
        settings_handler.set("speech","disable",str(self.speechSettings.disableEntrnalSpeech.isChecked()))
        if aa==1:
